...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, LocalDateTime startDateTime, LocalDateTime endDateTime) {
        if (!endDateTime.toLocalTime().equals(LocalTime.MAX)) {
            return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenHalfOpen(meal.getTime(), startDateTime.toLocalTime(), endDateTime.toLocalTime()));
        }
