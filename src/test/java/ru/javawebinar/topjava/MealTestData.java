...
public class MealTestData {
    ...
    public static final LocalDateTime LOCAL_DATE_TIME = LocalDateTime.of(2024, 2, 18, 18, 0, 0);
    ...
    public static Meal getNew() {
        return new Meal(null, LOCAL_DATE_TIME, "new meal", 275);
    }

    public static Meal getUpdated() {
        Meal updated = new Meal(meal);
        updated.setDateTime(LOCAL_DATE_TIME);
